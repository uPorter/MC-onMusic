...
import com.mc.onmusic_relase.adapters.PlaylistAdapter;
                        ...
                        if (playlist_csv != null && !playlist_csv.isEmpty()) {
                            if (model.getTimeseconds() > 0) {
                                new AlertDialog.Builder(getContext())
                                        .setTitle(R.string.dlttt)
                                        .setMessage(R.string.asdws)
                                        .setNegativeButton(R.string.cancel, null)
                                        .setPositiveButton(R.string.alert_yes_button, (dialogInterface, i) -> {
